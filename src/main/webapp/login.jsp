...
<body>
	...
	<div class = "log-box">
		<div class = "inner1">
			...
			<hr>
		<form action="hotellist.jsp" method="post">
			<table>
			<tr>
			...
			<tr>
				<td><input type="submit" value="LOGIN" class = "inp-but"></td>
			</tr>
			</table>
		</form>
		</div>
		<div class = "inner3">
			<img alt="logo" src="images/hotel_logo.png" style = "width: 80%; height: 80%" class = "img2">
		</div>
	</div>
